...
import { idlFactory } from './operational_governance.did.js';
export { idlFactory } from './operational_governance.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OPERATIONAL_GOVERNANCE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./operational_governance.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the operational_governance canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./operational_governance.did.js")._SERVICE>}
 */
export const operational_governance = createActor(canisterId);
