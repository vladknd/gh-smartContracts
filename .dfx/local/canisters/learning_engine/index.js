...
import { idlFactory } from './learning_engine.did.js';
export { idlFactory } from './learning_engine.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LEARNING_ENGINE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./learning_engine.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the learning_engine canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./learning_engine.did.js")._SERVICE>}
 */
export const learning_engine = createActor(canisterId);
