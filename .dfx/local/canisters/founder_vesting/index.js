...
import { idlFactory } from './founder_vesting.did.js';
export { idlFactory } from './founder_vesting.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FOUNDER_VESTING;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./founder_vesting.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the founder_vesting canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./founder_vesting.did.js")._SERVICE>}
 */
export const founder_vesting = createActor(canisterId);
