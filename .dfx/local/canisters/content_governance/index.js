...
import { idlFactory } from './content_governance.did.js';
export { idlFactory } from './content_governance.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CONTENT_GOVERNANCE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./content_governance.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the content_governance canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./content_governance.did.js")._SERVICE>}
 */
export const content_governance = createActor(canisterId);
