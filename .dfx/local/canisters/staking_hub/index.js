...
import { idlFactory } from './staking_hub.did.js';
export { idlFactory } from './staking_hub.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STAKING_HUB;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./staking_hub.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the staking_hub canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./staking_hub.did.js")._SERVICE>}
 */
export const staking_hub = createActor(canisterId);
