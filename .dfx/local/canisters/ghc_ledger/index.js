...
import { idlFactory } from './ghc_ledger.did.js';
export { idlFactory } from './ghc_ledger.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GHC_LEDGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ghc_ledger.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ghc_ledger canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ghc_ledger.did.js")._SERVICE>}
 */
export const ghc_ledger = createActor(canisterId);
